...
| `ALLOWED_ROLES_NO_AUTH`     | Allowed roles when authentication is disabled.                                                       | `array`  | ["plandev_admin", "user", "viewer"]              |
...
| `DEFAULT_ROLE_NO_AUTH`      | Default role when authentication is disabled.                                                        | `string` | plandev_admin                                    |
...
| `PLANDEV_DB_HOST`           | Hostname of the PlanDev PostgreSQL Database.                                                         | `string` | localhost                                      |
| `PLANDEV_DB_PORT`           | Port of the PlanDev PostgreSQL Database.                                                             | `number` | 5432                                           |
